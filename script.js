...
const matches = [
  ...
  },
  {
    ...
    result: [0, 2],
    predictions: {
      "Arturo Fabian Krauchuka": [0, 2], "José Pahr": [0, 2], "Ezequiel Villalba": [0, 3],
      "Facundo Stij": [0, 3], "leandro enriquez": [0, 4], "Sergio Villar": [1, 3]
    }
  },
  {
    home: { code: "CRO", name: "Croacia", iso: "hr" },
    away: { code: "GHA", name: "Ghana", iso: "gh" },
    result: [2, 1],
    predictions: {
      "José Pahr": [2, 1], "Ezequiel Villalba": [1, 0], "leandro enriquez": [1, 0],
      "Arturo Fabian Krauchuka": [3, 0], "Facundo Stij": [1, 1], "Sergio Villar": [2, 2]
    }
  },
  {
    home: { code: "COL", name: "Colombia", iso: "co" },
    away: { code: "POR", name: "Portugal", iso: "pt" },
    result: [0, 0],
    predictions: {
      "Ezequiel Villalba": [2, 2], "Facundo Stij": [1, 1], "leandro enriquez": [1, 2],
      "Arturo Fabian Krauchuka": [2, 1], "José Pahr": [0, 1], "Sergio Villar": [2, 1]
    }
  },
  {
    home: { code: "COD", name: "RD Congo", iso: "cd" },
    away: { code: "UZB", name: "Uzbekistán", iso: "uz" },
    result: [3, 1],
    predictions: {
      "Ezequiel Villalba": [1, 0], "Facundo Stij": [2, 1], "leandro enriquez": [2, 0],
      "Arturo Fabian Krauchuka": [2, 0], "Sergio Villar": [1, 0], "José Pahr": [1, 1]
    }
  },
  {
    home: { code: "ALG", name: "Argelia", iso: "dz" },
    away: { code: "AUT", name: "Austria", iso: "at" },
    result: [3, 3],
    predictions: {
      "Facundo Stij": [1, 1], "Sergio Villar": [1, 1], "Ezequiel Villalba": [2, 1],
      "leandro enriquez": [1, 2], "Arturo Fabian Krauchuka": [0, 2], "José Pahr": [0, 1]
    }
  },
  {
    home: { code: "JOR", name: "Jordania", iso: "jo" },
    away: { code: "ARG", name: "Argentina", iso: "ar" },
    result: [1, 3],
    predictions: {
      "Ezequiel Villalba": [0, 3], "Facundo Stij": [0, 3], "leandro enriquez": [0, 5],
      "Arturo Fabian Krauchuka": [0, 3], "José Pahr": [0, 2], "Sergio Villar": [0, 4]
    }
  },
  {
    home: { code: "RSA", name: "Sudáfrica", iso: "za" },
    ...
    result: [0, 1],
    predictions: {
      "Ezequiel Villalba": [1, 2], "Facundo Stij": [1, 2], "Arturo Fabian Krauchuka": [0, 2],
      "Sergio Villar": [1, 1], "leandro enriquez": null, "José Pahr": null
    }
  },
  {
    home: { code: "BRA", name: "Brasil", iso: "br" },
    ...
    predictions: {
      "Ezequiel Villalba": [2, 1], "Facundo Stij": [2, 1], "leandro enriquez": [2, 1],
      "Sergio Villar": [2, 1], "Arturo Fabian Krauchuka": [1, 2], "José Pahr": [1, 2]
    }
  },
  {
    home: { code: "GER", name: "Alemania", iso: "de" },
    ...
    result: [1, 1],
    predictions: {
      "Ezequiel Villalba": [2, 0], "Facundo Stij": [2, 0], "leandro enriquez": [2, 0],
      "Arturo Fabian Krauchuka": [0, 1], "José Pahr": [4, 1], "Sergio Villar": [3, 2]
    }
  },
  {
    home: { code: "NED", name: "Países Bajos", iso: "nl" },
    ...
    result: [1, 1],
    predictions: {
      "Ezequiel Villalba": [2, 2], "José Pahr": [2, 2], "Facundo Stij": [2, 1],
      "leandro enriquez": [2, 0], "Arturo Fabian Krauchuka": [2, 1], "Sergio Villar": [3, 1]
    }
  },
  {
    home: { code: "CIV", name: "Costa de Marfil", iso: "ci" },
    ...
    result: [1, 2],
    predictions: {
      "Ezequiel Villalba": [1, 2], "Facundo Stij": [1, 2], "leandro enriquez": [1, 2],
      "Arturo Fabian Krauchuka": [0, 2], "José Pahr": [1, 0], "Sergio Villar": null
    }
  },
  {
    home: { code: "FRA", name: "Francia", iso: "fr" },
    ...
    result: [3, 0],
    predictions: {
      "Ezequiel Villalba": [3, 1], "Facundo Stij": [3, 1], "leandro enriquez": [3, 1],
      "Arturo Fabian Krauchuka": [2, 1], "José Pahr": [2, 0], "Sergio Villar": [2, 0]
    }
  },
  {
    home: { code: "MEX", name: "México", iso: "mx" },
    ...
    result: [2, 0],
    predictions: {
      "leandro enriquez": [2, 0], "Facundo Stij": [1, 0], "Ezequiel Villalba": [0, 1],
      "Arturo Fabian Krauchuka": [1, 1], "José Pahr": [0, 1], "Sergio Villar": [1, 2]
    }
  },
  {
    home: { code: "ENG", name: "Inglaterra", iso: "gb-eng" },
    ...
    result: [2, 1],
    predictions: {
      "Ezequiel Villalba": [2, 1], "Sergio Villar": [2, 1], "Facundo Stij": [2, 0],
      "leandro enriquez": [2, 0], "José Pahr": [3, 0], "Arturo Fabian Krauchuka": null
    }
  },
  {
    home: { code: "BEL", name: "Bélgica", iso: "be" },
    ...
    result: [3, 2],
    predictions: {
      "Facundo Stij": [2, 1], "leandro enriquez": [3, 1], "José Pahr": [2, 0],
      "Sergio Villar": [2, 0], "Ezequiel Villalba": [1, 1], "Arturo Fabian Krauchuka": [2, 2]
    }
  },
  {
    home: { code: "USA", name: "Estados Unidos", iso: "us" },
    ...
    predictions: {
      "Ezequiel Villalba": [2, 0], "Facundo Stij": [2, 0], "leandro enriquez": [2, 0],
      "Arturo Fabian Krauchuka": [3, 1], "José Pahr": [3, 0], "Sergio Villar": [3, 1]
    }
  },
  {
    home: { code: "ESP", name: "España", iso: "es" },
    ...
    result: [3, 0],
    predictions: {
      "Ezequiel Villalba": [2, 1], "leandro enriquez": [2, 1], "José Pahr": [3, 1],
      "Arturo Fabian Krauchuka": [2, 2], "Sergio Villar": [1, 2], "Facundo Stij": null
    }
  },
  {
    home: { code: "POR", name: "Portugal", iso: "pt" },
    ...
    result: [2, 1],
    predictions: {
      "Ezequiel Villalba": [2, 1], "leandro enriquez": [2, 1], "Facundo Stij": [2, 0],
      "Arturo Fabian Krauchuka": [1, 2], "José Pahr": [1, 2], "Sergio Villar": [0, 2]
    }
  },
  {
    home: { code: "SUI", name: "Suiza", iso: "ch" },
    ...
    result: [2, 0],
    predictions: {
      "leandro enriquez": [2, 0], "Arturo Fabian Krauchuka": [2, 0], "José Pahr": [2, 0],
      "Sergio Villar": [2, 0], "Facundo Stij": [1, 0], "Ezequiel Villalba": [1, 1]
    }
  },
  {
    home: { code: "AUS", name: "Australia", iso: "au" },
    ...
    result: [1, 1],
    predictions: {
      "Ezequiel Villalba": [1, 2], "Facundo Stij": [2, 1], "leandro enriquez": [1, 2],
      "José Pahr": [3, 0], "Sergio Villar": [0, 1], "Arturo Fabian Krauchuka": null
    }
  },
  {
    home: { code: "ARG", name: "Argentina", iso: "ar" },
    ...
    result: [3, 2],
    predictions: {
      "Ezequiel Villalba": [2, 0], "Facundo Stij": [3, 0], "leandro enriquez": [3, 0],
      "Arturo Fabian Krauchuka": [1, 0], "José Pahr": [3, 0], "Sergio Villar": [3, 0]
    }
  },
  {
    home: { code: "COL", name: "Colombia", iso: "co" },
    ...
    result: [1, 0],
    predictions: {
      "Ezequiel Villalba": [1, 0], "leandro enriquez": [2, 1], "José Pahr": [2, 0],
      "Sergio Villar": [2, 1], "Facundo Stij": null, "Arturo Fabian Krauchuka": null
    }
  },
  {
    ...
    predictions: {
      "Ezequiel Villalba": [1, 2], "Facundo Stij": [0, 2], "leandro enriquez": [1, 2],
      "Arturo Fabian Krauchuka": [1, 2], "José Pahr": [2, 0], "Sergio Villar": null
    }
  },
  {
    home: { code: "PAR", name: "Paraguay", iso: "py" },
    ...
    result: [0, 1],
    predictions: {
      "Ezequiel Villalba": [0, 2], "Facundo Stij": [1, 3], "leandro enriquez": [1, 4],
      "José Pahr": [2, 3], "Arturo Fabian Krauchuka": [2, 1], "Sergio Villar": [2, 1]
    }
  },
  {
    home: { code: "BRA", name: "Brasil", iso: "br" },
    ...
    result: [1, 2],
    predictions: {
      "Sergio Villar": [0, 2], "Ezequiel Villalba": [2, 1], "Facundo Stij": [2, 1],
      "leandro enriquez": [3, 2], "Arturo Fabian Krauchuka": [2, 0], "José Pahr": [3, 1]
    }
  },
  {
    home: { code: "MEX", name: "México", iso: "mx" },
    ...
    result: [2, 3],
    predictions: {
      "Facundo Stij": [1, 2], "leandro enriquez": [1, 2], "Arturo Fabian Krauchuka": [0, 3],
      "José Pahr": [0, 3], "Sergio Villar": [1, 2], "Ezequiel Villalba": [1, 1]
    }
  },
  {
    home: { code: "POR", name: "Portugal", iso: "pt" },
    ...
    result: [0, 1],
    predictions: {
      "Facundo Stij": [0, 2], "leandro enriquez": [1, 2], "José Pahr": [1, 2],
      "Ezequiel Villalba": [2, 2], "Arturo Fabian Krauchuka": [2, 2], "Sergio Villar": null
    }
  },
  {
    home: { code: "USA", name: "Estados Unidos", iso: "us" },
    ...
    result: [1, 4],
    predictions: {
      "Facundo Stij": [1, 2], "Ezequiel Villalba": [2, 1], "leandro enriquez": [2, 1],
      "Arturo Fabian Krauchuka": [2, 0], "José Pahr": [1, 0], "Sergio Villar": [2, 0]
    }
  },
  {
    home: { code: "ARG", name: "Argentina", iso: "ar" },
    ...
    result: [3, 2],
    predictions: {
      "Ezequiel Villalba": [2, 0], "Facundo Stij": [2, 0], "Arturo Fabian Krauchuka": [3, 0],
      "José Pahr": [2, 0], "Sergio Villar": [3, 1], "leandro enriquez": null
    }
  },
  {
    ...
    result: [0, 0],
    predictions: {
      "Ezequiel Villalba": [1, 1], "Facundo Stij": [1, 2], "leandro enriquez": [1, 2],
      "Arturo Fabian Krauchuka": [2, 0], "José Pahr": [0, 2], "Sergio Villar": [3, 2]
    }
  },
  {
    home: { code: "FRA", name: "Francia", iso: "fr" },
  ...
  },
  {
    ...
    result: [3, 1],
    predictions: {
      "Facundo Stij": [3, 1], "leandro enriquez": [3, 1], "Arturo Fabian Krauchuka": [3, 1],
      "Ezequiel Villalba": [2, 0], "José Pahr": [2, 0], "Sergio Villar": [4, 1]
    }
  },
  {
    home: { code: "FRA", name: "Francia", iso: "fr" },
    ...
    result: [0, 2],
    predictions: {
      "Arturo Fabian Krauchuka": [0, 1], "José Pahr": [1, 3], "Sergio Villar": [1, 2],
      "Ezequiel Villalba": [3, 2], "Facundo Stij": [1, 1], "leandro enriquez": [2, 1]
    }
  },
  {
    home: { code: "ENG", name: "Inglaterra", iso: "gb-eng" },
    ...
    result: [1, 2],
    predictions: {
      "Ezequiel Villalba": [1, 2], "Facundo Stij": [1, 2], "Arturo Fabian Krauchuka": [0, 3],
      "José Pahr": [0, 2], "Sergio Villar": [1, 3], "leandro enriquez": null
    }
  },
  {
    home: { code: "FRA", name: "Francia", iso: "fr" },
    ...
    result: [4, 6],
    predictions: {
      "José Pahr": [0, 2], "Ezequiel Villalba": [3, 1], "Facundo Stij": [2, 1],
      "leandro enriquez": [2, 1], "Arturo Fabian Krauchuka": [2, 0], "Sergio Villar": [2, 1]
    }
  },
  {
    home: { code: "ESP", name: "España", iso: "es" },
    ...
    result: [1, 0],
    predictions: {
      "Ezequiel Villalba": [0, 1], "Facundo Stij": [1, 3], "Arturo Fabian Krauchuka": [1, 3],
      "José Pahr": [1, 3], "Sergio Villar": [0, 2], "leandro enriquez": null
    }
  }
];
